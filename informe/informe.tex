...
\indent // implica $(\forall h \leftarrow this.imagenes) pre(this).votos(h) ==  this.votos(h);$ \comment{por los 2 implica, los vectores de imagenes y votos de this y pre(this) estan ordenados igual y sin repetidos, entonces para todas las imagenes de this.imagenes compartiran los votos}\\
